...
def test():
	...
	print("sample: test") #added!!!
	print(sample) #added!!!
	f.close()
	for i in range(len(sample)):
		# print("sample[i]") #added!!!
		# print(sample[i]) #added!!!
		sample[i] = re.sub('\d+,', '', sample[i])
		# print("sample[i]: re.sub") #added!!!
		# print(sample[i]) #added!!!
		sample[i] = sample[i].strip().split(',')
		# print("sample[i]: strip.split") #added!!!
		# print(sample[i]) #added!!!
	# print("sample: test(2)") #added!!!
	# print(sample) #added!!!
	labels = []
	for s in sample:
		labels.append(s.pop())
	print("sample: test(3)") #added!!!
	print(sample) #added!!!
	# print(sample)
	# print(labels)
